...
<head>
  ...
  <title>Traveller Profile - TravelMate Admin</title>
    ...
    <div class="content">
      ...
      <div class="profile-page-header">
        <div class="page-title">
          <h1><i class="fas fa-hiking traveller-icon"></i> Traveller Profile</h1>
          <p class="subtitle">View and manage traveller information</p>
        </div>
      ...
      <?php if (isset($user)): ?>
        ...
        <div class="profile-layout">
          ...
          <div class="profile-sidebar-card">
            <div class="profile-cover traveller"></div>
            ...
            <div class="profile-identity">
              ...
              <span class="role-badge traveller"><i class="fas fa-hiking"></i> Traveller</span>
            ...
            <div class="detail-card">
              ...
              <div class="stats-grid">
                <div class="stat-block green">
                  ...
                  <span class="stat-label">Reviews / Blogs</span>
                </div>
