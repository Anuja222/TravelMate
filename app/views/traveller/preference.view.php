...
<head>
    ...
    <title>EcoAdventure - Discover Sri Lanka</title>
    <link rel="stylesheet" href="assets/css/Traveller/preference.css">
...
<body>
    ...
    <style>
        ...
        .category-card::after, .activity-card::after {
            content: "";
            position: absolute;
            top: 10px;
            right: 14px;
        ...
        .category-card.selected::after, .activity-card.selected::after {
            content: "✔";
    ...
    <script>
    document.querySelectorAll('.category-card, .activity-card').forEach(card => {
