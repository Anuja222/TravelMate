...
<head>
    ...
    <link rel="stylesheet" href="/TravelMate/public/assets/css/Accommodation/price.css">
...
<body>
    ...
    <section class="price-section">
        <h1>Add Price</h1>
        <form class="price-form" method="POST" action="/TravelMate/public/price" >
            <h2>Price Per Night</h2>
            <div class="price-box">
                <label><strong>How much do you want to charge per night?</strong></label>
                <input type="text" placeholder="LKR" id="price_night" name="price_night" required>
            ...
            <div class="price-box">
                ...
                <input type="text" placeholder="LKR" id="price_guest" name="price_guest">
            </div>
    ...
    <script src="/TravelMate/public/assets/js/Accommodation/price.js"></script>
    <script>
