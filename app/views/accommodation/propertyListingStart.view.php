...
<body>
    ...
    <main class="listing-main">
        ...
        <form id="propertyForm" method="POST" action="/TravelMate/public/selectPropertyType">
            <div class="property-types">
                <div class="property-row">
                    <button type="submit" name="property_type" value="Hotel" class="property-type hotel-link" style="cursor:pointer; width:100%;">
                        <div class="icon hotel-icon">
                            <img src="/TravelMate/public/assets/images/hotel.png" alt="Hotel" />
                        </div>
                        <h3>Hotel</h3>
                        <span class="list-property-btn" aria-hidden="true">Select</span>
                    </button>
                    
                    <button type="submit" name="property_type" value="Guest House" class="property-type guest-house-link" style="cursor:pointer; width:100%;">
                    ...
                    <button type="submit" name="property_type" value="Home Stay" class="property-type home-stay-link" style="cursor:pointer; width:100%;">
                ...
                <div class="property-row">
                    <button type="submit" name="property_type" value="Villa" class="property-type villa-link" style="cursor:pointer; width:100%;">
                    ...
                    <button type="submit" name="property_type" value="Apartment" class="property-type apartment-link" style="cursor:pointer; width:100%;">
                    ...
                    <button type="submit" name="property_type" value="Alternative" class="property-type alternative-link" style="cursor:pointer; width:100%;">
