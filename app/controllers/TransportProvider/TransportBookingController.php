    ...
    public function create()
    {
        try {
            ...
            $bookingData = [
                ...
                'luggage' => $input['luggage'] ?? 0,                'alternative_contact' => $input['alternative_contact'] ?? null,                'special_requirements' => $input['special_requirements'] ?? null,
                'duration' => $duration,
    ...
    public function update()
    {
        try {
            ...
            $updateData = [
                ...
                'alternative_contact' => $input['alternative_contact'] ?? null,
